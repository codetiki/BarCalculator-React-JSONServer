...
const BarChart = () => {
  ...
  // Hakunäkymä
  const [showTaulukkoForm, setShowTaulukkoForm] = useState(false);
  const [showTulosForm, setShowTulosForm] = useState(true);
  ...
  // Kuvaa klikkaamalla muutetaan samalla kuormatyyppi
  ...
  const onShowTaulukkoForm = () => {
    setShowTaulukkoForm(true);
    setShowTulosForm(false);
  }
  const onShowTulosForm = () => {
    setShowTaulukkoForm(false);
    setShowTulosForm(true);
  }
...

      {
        showTulosForm ?
            ...
            <Grid container spacing={2}>
              <Grid item xs={4}>
                ...
                <ShearForce
                  ...
                  setFormData={setFormData}
                />
                <button onClick={onShowTaulukkoForm}> Näytä taulukko</button>
              </Grid>
              <Grid item xs={8}>
          ...
          <div>
            ...
            <button onClick={onShowTulosForm}> Palaa tuloksiin</button>
            <ArrayBarResults
              name={name}
              length={length}
              lengthA={lengthA}
